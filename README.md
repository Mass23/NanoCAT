...
Note that any installation of qiime2 (amplicon version) with the addition of porechop (`https://bioconda.github.io/recipes/porechop/README.html`), chopper (`https://bioconda.github.io/recipes/chopper/README.html`), and vsearch (`https://bioconda.github.io/recipes/vsearch/README.html`) should work.
